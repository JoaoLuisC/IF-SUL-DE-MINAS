...
public class FormSistema extends javax.swing.JFrame {
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
       ...
       if(txtProduto.getText().equals("") || txtQtd.getText().equals(""))   //SE O BOTAO FOR ATIVADO E NAO TIVER NENHUM TEXTO EM ALGUM DOS CAMPOS
           JOptionPane.showMessageDialog(rootPane, "Inserir valores primeiro!");//CRIA UM ALERTA PARA INSERIR OS DADOS
       else{
           Produto novoProduto = new Produto();                             // SETA UM NOVO PRODUTO DO TIPO PRODUTO
           novoProduto.setDescricao(txtProduto.getText());                  // RECEBE O VALOR DA DESCRIÇÃO DO PRODUTO
           novoProduto.setQuantidade(Integer.parseInt(txtQtd.getText()));   // RECEBE O VALOR DA QUANTIDADE DO PRODUTO
           
           minhaPilha.push(novoProduto);                                    // ADICIONA O NOVO PRODUTO A PILHA
           
           txtProduto.setText("");                                          // DEFINE A CAIXA DE TEXTO PARA FICAR VAZIA NOVAMENTE
           txtQtd.setText("");                                              // DEFINE A CAIXA DE TEXTO PARA FICAR VAZIA NOVAMENTE
           
           mostraPilha(minhaPilha, listPilha);                              // MOSTRA O PRODUTO NA PILHA 
