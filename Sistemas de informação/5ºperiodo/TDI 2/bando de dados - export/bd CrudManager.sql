...
-- Copiando estrutura para tabela crud_manager.departaments
...
CREATE TABLE IF NOT EXISTS `departaments` (
  ...
  CONSTRAINT `fk_department_head` FOREIGN KEY (`department_head`) REFERENCES `users` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4;

-- Copiando dados para a tabela crud_manager.departaments: ~2 rows (aproximadamente)
DELETE FROM `departaments`;
/*!40000 ALTER TABLE `departaments` DISABLE KEYS */;
INSERT INTO `departaments` (`id`, `name`, `description`, `department_head`, `employee_count`, `phone`) VALUES
	(1, 'Departamento de Vendasasd', 'Vendas e afins', 1, 15, '3597'),
	(3, 'asd', 'asd', 1, 123, 'asd');
...
-- Copiando dados para a tabela crud_manager.sellers: ~0 rows (aproximadamente)
DELETE FROM `sellers`;
