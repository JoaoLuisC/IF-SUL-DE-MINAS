...
public class BTree<K extends Comparable<K>> implements Serializable {
    ...
    public final BTNode<K> nullBTNode = new BTNode<>();
...
//		stepMess.add("Insert " + key + " into the right place");
    ...
    private BTNode<K> getHalfKeys(BTNode<K> fullNode) {
        BTNode<K> newNode = new BTNode<>(order);
...
//				stepMess.add(" ");
     ...
     * Case 2: If k is in the node x which is a leaf and x.size -1 menor halfNumber 
